...
def id_nonce_signing_example():
    ...
    challenge_data = bytes.fromhex('000000000000000000000000000000006469736376350001010102030405060708090a0b0c00180102030405060708090a0b0c0d0e0f100000000000000000')
...
def id_nonce_signing_example_without_extra_entropy():
    ...
    assert signature == bytes.fromhex('94852a1e2318c4e5e9d422c98eaf19d1d90d876b29cd06ca7cb7546d0fff7b484fe86c09a064fe72bdbef73ba8e9c34df0cd2b53e9d65528c2c7f336d5dfc6e6')
...
def ping_handshake_example_id_nonce_signing_without_extra_entropy():
    ...
    challenge_data = bytes.fromhex('000000000000000000000000000000006469736376350001010102030405060708090a0b0c00180102030405060708090a0b0c0d0e0f100000000000000001')
    ephemeral_pubkey = bytes.fromhex('039a003ba6517b473fa0cd74aefe99dadfdb34627f90fec6362df85803908f53a5')
    node_id_b = bytes.fromhex('bbbb9d047f0488c0b5a93c1c3f2d8bafc7c8ff337024a55434a0d0555de64db9')

    signature = _build_id_signature(challenge_data, ephemeral_pubkey, node_id_b, False, key)
    assert signature == bytes.fromhex('c0a04b36f276172afc66a62848eb0769800c670c4edbefab8f26785e7fda6b56506a3f27ca72a75b106edd392a2cbf8a69272f5c1785c36d1de9d98a0894b2db')
...
def ping_handshake_with_record_example_id_nonce_signing_without_extra_entropy():
    ...
    signature = _build_id_signature(challenge_data, ephemeral_pubkey, node_id_b, False, key)
    assert signature == bytes.fromhex('a439e69918e3f53f555d8ca4838fbe8abeab56aa55b056a2ac4d49c157ee719240a93f56c9fccfe7742722a92b3f2dfa27a5452f5aca8adeeab8c4d5d87df555')
